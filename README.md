...
- **Mounties** — red serge jacket, campaign hat
- **Saskatchewan Raiders** — prairie outlaw

## Scenery props (KayKit CC0 from [itch.io](https://itch.io/game-assets/free/tag-3d))

Rockies, boreal trees, hills, rocks, oil barrels, and RCMP cruiser — from [KayKit](https://kaylousberg.itch.io/) packs.

## Getting Started

```bash
npm install
npm run fetch-assets   # optional scenery props
npm run dev
```
...
- **Drag** — pan the camera
- **Scroll** — zoom in/out
- **Click building in menu** — place on grid
- **Click placed building** — info, upgrade, train
